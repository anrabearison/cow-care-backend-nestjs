...
import { SanteAnimaleRagService } from './sante-animale-rag.service';
import { ChatRequestDto, ChatResponseDto } from '../dto/chat.dto';

@Injectable()
export class ChatbotSanteAnimaleService {
  private readonly logger = new Logger(ChatbotSanteAnimaleService.name);
...
👨‍⚕️ CONSULTATION: [type de professionnel à contacter]`;
  ...
  constructor(
    ...
    private ragService: SanteAnimaleRagService,
  ) {
