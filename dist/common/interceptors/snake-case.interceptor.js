...
const case_transform_util_1 = require("../utils/case-transform.util");
let SnakeCaseInterceptor = class SnakeCaseInterceptor {
    intercept(context, next) {
        return next.handle().pipe((0, operators_1.map)(data => (0, case_transform_util_1.transformKeysToSnakeCase)(data)));
    }
};
