...
let UsersService = class UsersService {
    ...
    async create(createUserDto) {
        ...
        const newUser = this.usersRepository.create(Object.assign(Object.assign({}, createUserDto), { id: crypto.randomUUID(), hashedPassword }));
        await this.usersRepository.save(newUser);
        const { hashedPassword: _ } = newUser, result = __rest(newUser, ["hashedPassword"]);
        return result;
    }
